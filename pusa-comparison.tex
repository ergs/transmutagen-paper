...
\caption{Computed partial fraction coefficients for degree 14. Differing
  digits are underlined. Note that~\oldcite{pusa2012correction} only has 19
  digits for $\mathrm{re}(\theta_5)$. \todo{Too many lines in the table?}}
...
\caption{Computed partial fraction coefficients for degree 16. Note that
  ...
  floating point precision.\todo{How do indicate that in the table?}}
