...
\begin{figure}[!ht]
\centering
\includegraphics[width=0.9\textwidth]{pusa-difference-14.pdf}
\caption{Difference between $\hat{r}_{14,14}$ for our computed values and the
  values from~\oldcite{pusa2012correction}.}
\label{fig:pusa-difference-14}
\end{figure}

\begin{figure}[!ht]
\centering
\includegraphics[width=0.9\textwidth]{pusa-difference-16.pdf}
