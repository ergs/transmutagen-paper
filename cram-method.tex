...
then stop iterating when the values of $\varepsilon_N$ become log-convex. See
Figure~\ref{fig:convergence-14-1000} for an example of the convergence of
$\varepsilon_N$ for degree 14, 1000 digits of precision.

\begin{figure}[!ht]
\centering
\includegraphics[width=0.9\textwidth]{convergence-14-1000.eps}
\caption{Convergence of the Remez algorithm for degree 14, 1000 digits of precision.}
