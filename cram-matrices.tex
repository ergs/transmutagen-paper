...
In transmutagen roots $\theta_i$ are computed with \texttt{sympy.nsolve} using Newton's
method.
\todo{Some discussion on the number of digits needed for the roots here.} The
